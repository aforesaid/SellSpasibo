...
{
    public class PayerTransactionManager : IPayerTransactionManager
    {
        private readonly ILogger<PayerTransactionManager> _logger;
        ...
        public PayerTransactionManager(ILogger<PayerTransactionManager> logger, IAccountObserver accountObserver,
